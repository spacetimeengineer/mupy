...
module square_cavity_array(x_spacing = 25, y_spacing = 25, x_units=8, y_units=8, x_cavity_dimensions=20, y_cavity_dimensions=20, z_cavity_dimensions=10)
{
    /*  Constants */
    ...
    for ( x_step = [ - x_length / 2 : x_spacing : x_length / 2 ])
    {
        ...
        {
            translate([x_step,y_step, 0 ]) { rotate([0,0,0]) { cube([x_cavity_dimensions,y_cavity_dimensions,z_cavity_dimensions], center = true); } }
        }
    }
}

module circular_cavity_array(x_spacing = 25, y_spacing = 25, x_units=8, y_units=8, x_cavity_dimensions=20, y_cavity_dimensions=20, z_cavity_dimensions=10)
{
    /*  Constants */
    x_length = ( x_units - 1 ) * x_spacing;
    y_length = ( y_units - 1 ) * y_spacing;
...
/*CUBX0177-BPAN-B25SR2P5-X8Y8PP2-R-T-SX25Y25-X8Y8-x20Y2010*/
module CUBX0177_BPAN(block_length = 25, shaft_radius=2.5, xunits=8, yunits=8, padding = 0.2, side_teeth_orientation = "regular", top_teeth_included = true, x_spacing = 25, y_spacing = 25, x_units=8, y_units=8, x_cavity_dimensions=20, y_cavity_dimensions=20, z_cavity_dimensions=10)
{
    difference()
    {
        union()
        ...
        square_cavity_array(x_spacing = 25, y_spacing = 25, x_units=8, y_units=8, x_cavity_dimensions=20, y_cavity_dimensions=20, z_cavity_dimensions=10);
...
CUBX0177_BPAN(block_length = 25, shaft_radius=2.5, xunits=8, yunits=8, padding = 0.2, side_teeth_orientation = "regular", top_teeth_included = true, x_spacing = 25, y_spacing = 25, x_units=8, y_units=8, x_cavity_dimensions=20, y_cavity_dimensions=20, z_cavity_dimensions=10);
