...
class CUSBX0188:
    ...
    def __init__(self, system_code, workspace_directory):
        ...
        if (self.type_code=="REG"): # Box panel.
            ...
            panel_a = mu.Hardware("panel_a", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_a_x_block_units)+"Y"+str(panel_a_y_block_units)+"PP2-RF-SX5Y3-X1Y1-XO0YO0-X30Y30Z20-S") # Constructs panel : This hardware component is a box panel of a CUBX0188 class hardware component. This CUBX0188 component
            panel_b = mu.Hardware("panel_b", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_b_x_block_units)+"Y"+str(panel_b_y_block_units)+"PP2-RF-SX5Y3-X1Y1-XO0YO0-X30Y30Z20-S") # Constructs panel A
            panel_c = mu.Hardware("panel_c", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_c_x_block_units)+"Y"+str(panel_c_y_block_units)+"PP2-RF-SX5Y10-X1Y1-XO0YO0-X30Y30Z20-S")
            panel_d = mu.Hardware("panel_d", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_d_x_block_units)+"Y"+str(panel_d_y_block_units)+"PP2-RF-SX5Y10-X1Y1-XO0YO0-X30Y30Z20-S")
            panel_e = mu.Hardware("panel_e", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_e_x_block_units)+"Y"+str(panel_e_y_block_units)+"PP2-RF-SX5Y5-X1Y1-XO0YO0-X30Y30Z20-S")
            panel_f = mu.Hardware("panel_f", "CUBX0188-BPAN-B"+str(self.unit_block_length)+"SR"+str(self.shaft_radius)+"-X"+str(panel_f_x_block_units)+"Y"+str(panel_f_y_block_units)+"PP2-RF-SX5Y5-X1Y1-XO0YO0-X30Y30Z20-S")
